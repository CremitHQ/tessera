...
impl ECP4 {
    pub fn new() -> ECP4 {
        ECP4 { x: FP4::new(), y: FP4::new_int(1), z: FP4::new() }
    }
    #[allow(non_snake_case)]
    ...
    pub fn generator() -> ECP4 {
        ECP4::new_fp4s(
            &FP4::new_fp2s(
                &FP2::new_bigs(&BIG::new_ints(&rom::CURVE_PXAA), &BIG::new_ints(&rom::CURVE_PXAB)),
                &FP2::new_bigs(&BIG::new_ints(&rom::CURVE_PXBA), &BIG::new_ints(&rom::CURVE_PXBB)),
            ),
            &FP4::new_fp2s(
                &FP2::new_bigs(&BIG::new_ints(&rom::CURVE_PYAA), &BIG::new_ints(&rom::CURVE_PYAB)),
                &FP2::new_bigs(&BIG::new_ints(&rom::CURVE_PYBA), &BIG::new_ints(&rom::CURVE_PYBB)),
            ),
        )
    }
